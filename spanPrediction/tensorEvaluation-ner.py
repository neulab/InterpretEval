...
def getAttrValue(test_word_sequences, test_trueTag_sequences, test_word_sequences_sent,
	...
	return  dict_entity2amb, dict_token2amb, dict_entity2fre, dict_token2fre, dict_entity2elen, dict_entity2slen, dict_entity2eden, dict_entity2oden, dict_entity2tag
...
def new_metric(corpus_type, column_no, mode, pos_column, train_vocab, n_buckets, dict_aspect_func,
	...
	dict_entity2elen, dict_entity2slen, dict_entity2eden, dict_entity2oden, dict_entity2tag = getAttrValue(test_word_sequences, test_trueTag_sequences, test_word_sequences_sent,
																			preCompute_ambSpan,
																			preCompute_ambToken,
																			preCompute_freqSpan,
																			preCompute_freqToken,
	...
	dict_entity2elen_pred, dict_entity2slen_pred, dict_entity2eden_pred, dict_entity2oden_pred, dict_entity2tag_pred= getAttrValue(test_word_sequences, test_predTag_sequences, test_word_sequences_sent,
																			preCompute_ambSpan,
																			preCompute_ambToken,
																			preCompute_freqSpan,
																			preCompute_freqToken,
	...
	# # dict_bucket2span_amb = bucketAttribute_SpecifiedBucketValue(dict_entity2amb, n_buckets, dict_hardcoded_mode[1])
	# # MF-et
	# dict_bucket2span_amb = bucketAttribute_SpecifiedBucketInterval(dict_entity2amb,[(0,), (0, 0.5), (0.5, 0.999), (1,)])
	# # MF-tt
	# dict_bucket2token_amb = bucketAttribute_SpecifiedBucketValue(dict_token2amb, n_buckets, dict_hardcoded_mode[1])
	# # F-ent 
	# dict_bucket2span_fre = bucketAttribute_SpecifiedBucketValue(dict_entity2fre, n_buckets, dict_hardcoded_mode[3])
	# # F-tok
	# dict_bucket2token_fre = bucketAttribute_SpecifiedBucketValue(dict_token2fre, n_buckets, dict_hardcoded_mode[3])
	# # R-eLen
	# dict_bucket2span_elen =bucketAttribute_SpecifiedBucketValue(dict_entity2elen, n_buckets, dict_hardcoded_mode[5])
	# # R-sLen
	# dict_bucket2span_slen =bucketAttribute_SpecifiedBucketValue(dict_entity2slen, n_buckets, dict_hardcoded_mode[4])
	# # R-eDen
	# dict_bucket2span_eden =bucketAttribute_SpecifiedBucketValue(dict_entity2eden, n_buckets, dict_hardcoded_mode[4])
	# # R-oov
	# dict_bucket2span_oden =bucketAttribute_SpecifiedBucketValue(dict_entity2oden, n_buckets, dict_hardcoded_mode[3])
	# # R-tag
	# dict_bucket2span_tag = bucketAttribute_DiscreteValue(dict_entity2tag, 100)
	...
	# # MF-et
	# dict_bucket2span_amb = __selectBucktingFunc(dict_aspect_func["MF-et"][0], dict_aspect_func["MF-et"][1], dict_entity2amb)
	# # MF-tt
	# dict_bucket2token_amb = __selectBucktingFunc(dict_aspect_func["MF-tt"][0], dict_aspect_func["MF-tt"][1], dict_token2amb)
	# # F-ent 
	# dict_bucket2span_fre = __selectBucktingFunc(dict_aspect_func["F-ent"][0], dict_aspect_func["F-ent"][1], dict_entity2fre)
	# # F-tok 
	# dict_bucket2token_fre = __selectBucktingFunc(dict_aspect_func["F-tok"][0], dict_aspect_func["F-tok"][1], dict_token2fre)
	# # R-eLen
	# dict_bucket2span_elen =__selectBucktingFunc(dict_aspect_func["R-eLen"][0], dict_aspect_func["R-eLen"][1], dict_entity2elen)
	# # R-sLen
	# dict_bucket2span_slen =__selectBucktingFunc(dict_aspect_func["R-sLen"][0], dict_aspect_func["R-sLen"][1], dict_entity2slen)
	# # R-eDen
	# dict_bucket2span_eden =__selectBucktingFunc(dict_aspect_func["R-eDen"][0], dict_aspect_func["R-eDen"][1], dict_entity2eden)
	# # R-oov
	# dict_bucket2span_oden =	__selectBucktingFunc(dict_aspect_func["R-oov"][0], dict_aspect_func["R-oov"][1], dict_entity2oden)
	# # R-tag
	# dict_bucket2span_tag = __selectBucktingFunc(dict_aspect_func["R-tag"][0], dict_aspect_func["R-tag"][1], dict_entity2tag)





	# dict_bucket2span_amb_pred =  bucketAttribute_SpecifiedBucketInterval(dict_entity2amb_pred, dict_bucket2span_amb.keys())
	# dict_bucket2span_amb_pred =  bucketAttribute_SpecifiedBucketInterval(dict_entity2amb_pred, dict_bucket2span_amb.keys())
	# dict_bucket2token_amb_pred = bucketAttribute_SpecifiedBucketInterval(dict_token2amb_pred, dict_bucket2token_amb.keys())
	# dict_bucket2span_fre_pred =  bucketAttribute_SpecifiedBucketInterval(dict_entity2fre_pred, dict_bucket2span_fre.keys())
	# dict_bucket2token_fre_pred = bucketAttribute_SpecifiedBucketInterval(dict_token2fre_pred, dict_bucket2token_fre.keys())
	# dict_bucket2span_elen_pred = bucketAttribute_SpecifiedBucketInterval(dict_entity2elen_pred, dict_bucket2span_elen.keys())
	# dict_bucket2span_slen_pred = bucketAttribute_SpecifiedBucketInterval(dict_entity2slen_pred, dict_bucket2span_slen.keys())
	# dict_bucket2span_eden_pred = bucketAttribute_SpecifiedBucketInterval(dict_entity2eden_pred, dict_bucket2span_eden.keys())
	# dict_bucket2span_oden_pred = bucketAttribute_SpecifiedBucketInterval(dict_entity2oden_pred, dict_bucket2span_oden.keys())
	# dict_bucket2span_tag_pred  = bucketAttribute_SpecifiedBucketInterval(dict_entity2tag_pred, dict_bucket2span_tag.keys())
	print('finish bucketAttribute_SpecifiedBucketInterval ...')




	################       Calculate Bucket-wise F1 Score:
	# dict_bucket2f1_span_amb  = getBucketF1(dict_bucket2span_amb,  dict_bucket2span_amb_pred)
	# dict_bucket2f1_token_amb = getBucketF1(dict_bucket2token_amb, dict_bucket2token_amb_pred)
	# dict_bucket2f1_span_fre  = getBucketF1(dict_bucket2span_fre,  dict_bucket2span_fre_pred)
	# dict_bucket2f1_token_fre = getBucketF1(dict_bucket2token_fre, dict_bucket2token_fre_pred)
	# dict_bucket2f1_span_elen = getBucketF1(dict_bucket2span_elen, dict_bucket2span_elen_pred)
	# dict_bucket2f1_span_slen = getBucketF1(dict_bucket2span_slen, dict_bucket2span_slen_pred)
	# dict_bucket2f1_span_eden = getBucketF1(dict_bucket2span_eden, dict_bucket2span_eden_pred)
	# dict_bucket2f1_span_oden = getBucketF1(dict_bucket2span_oden, dict_bucket2span_oden_pred)

	#dict_bucket2f1_span_tag = getBucketF1(dict_bucket2span_tag, dict_bucket2span_tag_pred)
	print('finish getBucketF1 ...')
	...
	# return dict_bucket2f1_span_amb, dict_bucket2f1_token_amb, dict_bucket2f1_span_fre, dict_bucket2f1_token_fre, \
	# 		dict_bucket2f1_span_elen, dict_bucket2f1_span_slen, \
	# 		dict_bucket2f1_span_eden, dict_bucket2f1_span_oden, dict_bucket2f1_span_tag
...
if __name__ == '__main__':
	...
	for ind, corpus_type in enumerate(corpus_types):
		...
		#fwrite_evaluate.write("\n")
		#data_dir = './preComputed/ner_results/'
		# data_dir = 'tacl_ner_results/'
		column_no = -1
		mode = ' '
		pos_column = 0
		...
		# fn_train = '/home/ubuntu/data/data-ner/NER/'+corpus_type +'/train.txt'
		# fn_test = '/home/ubuntu/data/data-ner/NER/'+corpus_type +'/test.txt'
		#fn_train = 'data/NER/' + corpus_type + '/train.txt'
		#fn_test = 'data/NER/' + corpus_type + '/test.txt'



		# fn_test = 'new_metric/analysis/new_york_example.txt'
		train_vocab              = path_preComputed + '/vocab-ner/'+ corpus_type + '_vocab.txt'
		fnwrite_GoldenEntityHard = path_preComputed + '/ner_metric/metric_feature/' + corpus_type + '_rhoSpan_inTrain_fami.pkl'
		fnwrite_TokenHard        = path_preComputed + '/ner_metric/metric_feature/' + corpus_type + '_rhoToken_inTrain_fami.pkl'
		fwrite_TokenFreq_inTrain = path_preComputed + '/ner_metric/metric_feature/' + corpus_type + '_Token_inTrain_freq.pkl'
		fwrite_SpanFreq_inTrain  = path_preComputed + '/ner_metric/metric_feature/' + corpus_type + '_Span_inTrain_freq.pkl'
		...
		for fn_result, model_name in zip(fn_results_sub, model_names):
			...
			# dict_bucket2f1_span_amb, dict_bucket2f1_token_amb, dict_bucket2f1_span_fre, dict_bucket2f1_token_fre, \
			# dict_bucket2f1_span_elen, dict_bucket2f1_span_slen, \
			# dict_bucket2f1_span_eden, dict_bucket2f1_span_oden, dict_bucket2f1_span_tag 
